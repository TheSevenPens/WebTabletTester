...
export let uxProcessingSettings = {
    get pressureCurveAmountSlider() { return /** @type {HTMLInputElement} */ (document.getElementById("pressureCurveAmountSlider")); },
    get positionSmoothingSlider() { return /** @type {HTMLInputElement} */ (document.getElementById("positionSmoothingSlider")); },
    get positionSmoothingValue() { return document.getElementById("positionSmoothingValue"); },
    get pressureSmoothingSlider() { return /** @type {HTMLInputElement} */ (document.getElementById("pressureSmoothingSlider")); },
    ...
    get tiltSmoothingSlider() { return /** @type {HTMLInputElement} */ (document.getElementById("tiltSmoothingSlider")); },
    get tiltSmoothingValue() { return document.getElementById("tiltSmoothingValue"); },
    get pressureQuantizationDropdown() { return /** @type {HTMLSelectElement} */ (document.getElementById("pressureQuantSelect")); },
};
